...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.c316ba1d09a471b70fe8cd77df36ba6abcb759c4f9e5d8daaec249aad795edab.js',function(){input.required=false;search();});}
